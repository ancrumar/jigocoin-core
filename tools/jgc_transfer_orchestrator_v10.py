...
AMOUNT_PER_TX = 5   # cantidad fija por envío

SEND_DELAY = 5      # segundos entre envíos
...
def sweep_transfers(active):
    ...
    for sender in active:
        ...
        for receiver in active:
            ...
            if balance - AMOUNT_PER_TX < MIN_BALANCE_REQUIRED:
                continue
            ...
            log(f"{sender} -> {receiver} {AMOUNT_PER_TX} JGC")
