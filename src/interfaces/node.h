...
#ifndef JIGOCOIN_INTERFACES_NODE_H
#define JIGOCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a jigocoin node (jigocoind process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or jigocoin.conf.
...
#endif // JIGOCOIN_INTERFACES_NODE_H
