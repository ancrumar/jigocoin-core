...
#ifndef JIGOCOIN_INTERFACES_INIT_H
#define JIGOCOIN_INTERFACES_INIT_H
...
//! (jigocoin-gui, jigocoin-node, jigocoin-wallet, jigocoind, jigocoin-qt) and each
...
#endif // JIGOCOIN_INTERFACES_INIT_H
