...
{
    // Regression test for jigocoin/jigocoin#34711, jigocoin/jigocoin#34756 where a
...
{
    // Regression test for jigocoin/jigocoin#34777 heap-use-after-free where
...
{
    // Regression test for jigocoin/jigocoin#34782 stack-use-after-return where
