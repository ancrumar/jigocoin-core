...
extern thread_local ThreadContext g_thread_context; // NOLINT(jigocoin-nontrivial-threadlocal)
// Silence nonstandard jigocoin tidy error "Variable with non-trivial destructor
