...
#ifndef JIGOCOIN_IPC_CAPNP_COMMON_TYPES_H
#define JIGOCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between jigocoin processes.
...
//! Functions to serialize / deserialize common jigocoin types.
namespace mp {
...
#endif // JIGOCOIN_IPC_CAPNP_COMMON_TYPES_H
