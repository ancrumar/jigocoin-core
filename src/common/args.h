...
#ifndef JIGOCOIN_COMMON_ARGS_H
#define JIGOCOIN_COMMON_ARGS_H
...
extern const char * const JIGOCOIN_CONF_FILENAME;
extern const char * const JIGOCOIN_SETTINGS_FILENAME;
