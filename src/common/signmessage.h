...
#ifndef JIGOCOIN_COMMON_SIGNMESSAGE_H
#define JIGOCOIN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's jigocoin address, it must refer to a public key.
...
#endif // JIGOCOIN_COMMON_SIGNMESSAGE_H
