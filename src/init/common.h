...
//! @file
//! @brief Common init functions shared by jigocoin-node, jigocoin-wallet, etc.

#ifndef JIGOCOIN_INIT_COMMON_H
#define JIGOCOIN_INIT_COMMON_H
