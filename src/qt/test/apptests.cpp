...
//! Entry point for JigocoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &JigocoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for JigocoinGUI tests.
void AppTests::guiTests(JigocoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &JigocoinGUI::consoleShown, this, &AppTests::consoleTests);
