...
{
    // Test regression https://github.com/jigocoin/jigocoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/jigocoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/jigocoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Jigocoin/Jigocoin-Qt.conf and all else left as default,
    // jigocoin-qt should set both -listen and -listenonion to false and start successfully.
