...
#ifndef JIGOCOIN_QT_JIGOCOINGUI_H
#define JIGOCOIN_QT_JIGOCOINGUI_H
...
/**
  Jigocoin GUI main class. This class represents the main window of the Jigocoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class JigocoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit JigocoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~JigocoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a jigocoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, JigocoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Jigocoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(JigocoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // JIGOCOIN_QT_JIGOCOINGUI_H
