...
#ifndef JIGOCOIN_QT_OPTIONSMODEL_H
#define JIGOCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Jigocoin client.
...
public:
    ...
    JigocoinUnit getDisplayUnit() const { return m_display_jigocoin_unit; }
...
private:
    ...
    QString language;
    JigocoinUnit m_display_jigocoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(JigocoinUnit unit);
...
#endif // JIGOCOIN_QT_OPTIONSMODEL_H
