...
#ifndef JIGOCOIN_QT_RECEIVECOINSDIALOG_H
#define JIGOCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of jigocoins */
...
#endif // JIGOCOIN_QT_RECEIVECOINSDIALOG_H
