...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = JigocoinUnits::formatWithUnit(unit, amount, true, JigocoinUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    JigocoinUnit unit{JigocoinUnit::BTC};
...
{
    JigocoinUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(JigocoinUnits::formatWithPrivacy(unit, balances.balance, JigocoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(JigocoinUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, JigocoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(JigocoinUnits::formatWithPrivacy(unit, balances.immature_balance, JigocoinUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(JigocoinUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, JigocoinUnits::SeparatorStyle::ALWAYS, m_privacy));
