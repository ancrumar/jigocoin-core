...
#ifndef JIGOCOIN_QT_SENDCOINSENTRY_H
#define JIGOCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending jigocoins.
 */
...
#endif // JIGOCOIN_QT_SENDCOINSENTRY_H
