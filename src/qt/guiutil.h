...
#ifndef JIGOCOIN_QT_GUIUTIL_H
#define JIGOCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Jigocoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "jigocoin:" URI into recipient object, return true on successful parsing
