...
#ifndef JIGOCOIN_NODE_CONNECTION_TYPES_H
#define JIGOCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/jigocoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Jigocoin’s Peer-to-Peer Network")
...
#endif // JIGOCOIN_NODE_CONNECTION_TYPES_H
