...
#ifndef JIGOCOIN_TXGRAPH_H
#define JIGOCOIN_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvingjigocoin.org/t/introduction-to-cluster-linearization/1032
 *
