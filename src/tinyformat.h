...
#include <algorithm>
#include <attributes.h> // Added for Jigocoin Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Jigocoin Core
#include <util/string.h> // Added for Jigocoin Core
...
// Added for Jigocoin Core. Similar to std::runtime_format from C++26.
...
// Added for Jigocoin Core. Wrapper for checking format strings at compile time.
