...
#ifndef JIGOCOIN_TXREQUEST_H
#define JIGOCOIN_TXREQUEST_H
 ...
 *   specific transaction. See https://jigocoincore.org/en/2024/07/03/disclose_already_asked_for.
 */
