...
#ifndef JIGOCOIN_WALLET_WALLETUTIL_H
#define JIGOCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! jigocoin from opening the wallet, thinking it was newly created, and
...
#endif // JIGOCOIN_WALLET_WALLETUTIL_H
