...
#ifndef JIGOCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define JIGOCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // JIGOCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
