...
#ifndef JIGOCOIN_WALLET_WALLET_H
#define JIGOCOIN_WALLET_WALLET_H
...
public:
     ...
     * jigocoin-wallet tool code or by wallet migration code. If this is called
...
#endif // JIGOCOIN_WALLET_WALLET_H
