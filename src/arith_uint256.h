...
#ifndef JIGOCOIN_ARITH_UINT256_H
#define JIGOCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Jigocoin only uses this "compact" format for encoding difficulty
...
#endif // JIGOCOIN_ARITH_UINT256_H
