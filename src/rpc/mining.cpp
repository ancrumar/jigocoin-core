...
static RPCMethod generatetodescriptor()
{
    return RPCMethod{
        ...
        "Mine to a specified descriptor and return the block hashes.",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated jigocoin to."},
        ...
        "Mine to a specified address and return the block hashes.",
         {
             ...
             {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated jigocoin to."},
             {"maxtries", RPCArg::Type::NUM, RPCArg::Default{DEFAULT_MAX_TRIES}, "How many iterations to try."},
         },
         RPCResult{
             RPCResult::Type::ARR, "", "hashes of blocks generated",
         ...
         RPCExamples{
            ...
            + "If you are using the " CLIENT_NAME " wallet, you can get a new address to send the newly generated jigocoin to with:\n"
...
static RPCMethod generateblock()
{
    return RPCMethod{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated jigocoin to."},
...
// NOTE: Unlike wallet RPC (which use BTC values), mining RPCs follow GBT (BIP 22) in using kano amounts
        ...
        RPCResult{
            RPCResult::Type::OBJ_DYN, "", "prioritisation keyed by txid",
            {
                {RPCResult::Type::OBJ, "<transactionid>", "", {
                    {RPCResult::Type::NUM, "fee_delta", "transaction fee delta in kanos"},
...
static RPCMethod getblocktemplate()
{
    return RPCMethod{
        ...
        "    https://github.com/jigocoin/bips/blob/master/bip-0022.mediawiki\n"
        "    https://github.com/jigocoin/bips/blob/master/bip-0023.mediawiki\n"
        "    https://github.com/jigocoin/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
        "    https://github.com/jigocoin/bips/blob/master/bip-0145.mediawiki\n",
        {
...
// allow mining without peers or IBD in standalone network
    ...
    if (!lpval.isNull()) {
         ...
         *
         * getblocktemplate is unlikely to be called by jigocoin-cli, so
...
static RPCMethod submitblock()
{
    ...
    return RPCMethod{
        ...
        "See https://en.jigocoin.it/wiki/BIP_0022 for full specification.\n",
        {
