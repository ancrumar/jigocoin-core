...
#ifndef JIGOCOIN_TXMEMPOOL_H
#define JIGOCOIN_TXMEMPOOL_H
 ...
 * Jigocoin-specific logic. Specifically, TxGraph handles (for each transaction)
 ...
 *
 * CTxMemPool itself handles the Jigocoin-specific parts of mempool
