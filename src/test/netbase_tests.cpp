...
{
    BOOST_CHECK(TestSplitHost("www.jigocoincore.org", "www.jigocoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.jigocoincore.org]", "www.jigocoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.jigocoincore.org:80", "www.jigocoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.jigocoincore.org]:80", "www.jigocoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.jigocoincore.org:65536", "www.jigocoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.jigocoincore.org:0", "www.jigocoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.jigocoincore.org:", "www.jigocoincore.org:", 0, false));
}
