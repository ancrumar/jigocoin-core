...
#ifndef JIGOCOIN_TEST_SCRIPTNUM10_H
#define JIGOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Jigocoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // JIGOCOIN_TEST_SCRIPTNUM10_H
