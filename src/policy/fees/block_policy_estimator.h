...
#ifndef JIGOCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
#define JIGOCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
...
#endif // JIGOCOIN_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
