...
#ifndef JIGOCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
#define JIGOCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
...
#endif // JIGOCOIN_PRIMITIVES_TRANSACTION_IDENTIFIER_H
