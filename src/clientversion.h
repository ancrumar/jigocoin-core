...
#ifndef JIGOCOIN_CLIENTVERSION_H
#define JIGOCOIN_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by jigocoin-build-config.h or in any other way
#endif
...
#endif // JIGOCOIN_CLIENTVERSION_H
