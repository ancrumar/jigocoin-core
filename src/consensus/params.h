...
#ifndef JIGOCOIN_CONSENSUS_PARAMS_H
#define JIGOCOIN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Jigocoin Script solution
...
#endif // JIGOCOIN_CONSENSUS_PARAMS_H
